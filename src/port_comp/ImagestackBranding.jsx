...
import logod from '../assets/images/logo d.jpg';


const images = [cardio, logo, logod];
...
export default function ImagestackProduct() {
  ...
  return (
    <div className="p-4 mx-auto w-fit items-center justify-center text-center">
      {/* Stacked Preview */}
      <div className="relative text-center  flex justify-center items-center h-32 pb-20">
