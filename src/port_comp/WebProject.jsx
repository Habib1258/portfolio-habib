    ...
    <>
          <section className='bg-custom-dark w-full text-Text-Primary py-3 lg:py-6 px-8 lg:px-48 font-bebas  place-content-center 2xl:px-[500px] lg:pb-20 '>
              ...
              <div className='grid w-full'>     
                  <Project>
                          <img src={ saidal} className='w-auto h-auto lg:w-auto lg:h-auto rounded-t-xl mx-1 lg:rounded-l-2xl lg:rounded-r-none drop-shadow-2xl ' alt='Project 1' />
...
Developed a web-based HR module to manage part-time staff for SAIDAL Group. Designed and implemented core features (staff records, scheduling, reporting) using [tech stack], improving efficiency and data accuracy.</p>
                  ...
                  <Project>
                    <img src={buybay} className='w-auto h-auto lg:w-auto lg:h-auto rounded-t-xl mx-1 lg:rounded-l-2xl lg:rounded-r-none drop-shadow-2xl' alt='Project 1' />
                    <div className='pl-4 text-center'>
                  ...
                  <Project>
                    <img src={odelice} className='w-auto h-auto lg:w-auto lg:h-auto rounded-t-xl mx-1  lg:rounded-l-2xl lg:rounded-r-none drop-shadow-2xl' alt='Project 1' />
                    <div className='pl-4 text-center'>
                  ...
                  <Project>
                    <img src={car} className='w-auto h-auto lg:w-auto lg:h-auto rounded-t-xl mx-1 lg:rounded-l-2xl lg:rounded-r-none drop-shadow-2xl' alt='Project 1' />
                    <div className='pl-4 text-center'>
