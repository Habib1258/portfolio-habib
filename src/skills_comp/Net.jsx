...
const Net = () => {
  return (
      <>
        <section className='bg-custom-dark text-white w-full overflow-x-hidden pb-36 pl-16 lg:pl-48 font-bebas grid grid-cols-1 place-content-center 2xl:px-[500px]'>
